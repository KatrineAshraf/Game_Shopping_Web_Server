CREATE TABLE customers (id INT AUTO_INCREMENT PRIMARY KEY, fname VARCHAR(25) NOT NULL, lname varchar(25) not null, email varchar(50) not null unique,  balance DECIMAL(10,2) not null default 0.00, password varchar(8));
create view allcustomers as
SELECT id, concat_ws(' ', fname, lname) as "name", email, balance
  from customers; 
CREATE TABLE products (id INT AUTO_INCREMENT PRIMARY KEY, p_name Varchar(25), image Varchar(300), price DECIMAL(10,2), qty INT);
